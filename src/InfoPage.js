  ...
  return (
    <div className="card">
      ...
      <div className="row centerMedia">
        <div>
          <ReactPlayer
            alt="Coronavirus explained and how to protect yourself from COVID-19"
      ...
      <div className="row centerMedia">
        <div>
          <ReactPlayer
            ...
            className="formatMedia"
            url="https://vp.nyt.com/video/2020/03/12/85578_1_HowToWashYourHands_wg_1080p.mp4"
            playing={true}
            loop={true}
          />
      ...
      <div className="row centerMedia">
        <div>
          <ReactPlayer
            alt="How to wear a mask - Coronavirus / COVID-19"
            className="formatMedia"
            url="https://www.youtube.com/watch?time_continue=107&v=lrvFrH_npQI&feature=emb_title"
            controls={true}
          />
          <small className="mediaText">
            How to properly wear and dispose of masks.
          </small>
        </div>
      </div>
          ...
          <div key={uuid()}>
            <ExpansionPanel style={{ boxShadow: "none" }}>
              ...
              <ExpansionPanelDetails
                style={{ textAlign: "left", marginLeft: "1em", padding: "0px" }}
              >
                <div>
                  {/* First block of text */}
      ...
      <div className="row alignStyles responsiveText">
        <div>
          <h3>
            National helplines operating 24 hours a day, seven days a week.
          </h3>
          <ul>
            <li>
              For information on coronavirus (COVID-19) at the National
              Helpline:{" "}
              <a className="citationLink" href="tel:1800020080">
                1800 020 080
              </a>
            </li>
            <li>
              If you are feeling unwell, call Healthdirect:{" "}
              <a className="citationLink" href="tel:1800022222">
                1800 022 222
              </a>
            </li>
          </ul>
          ...
          <ul>
            <li>
              Victoria:{" "}
              <a className="citationLink" href="tel:1800675398">
                1800 675 398
              </a>
            </li>
            <li>
              Queensland:{" "}
              <a className="citationLink" href="tel:13432584">
                13 43 25 84
              </a>
            </li>
            <li>
              Northern Territory:{" "}
              <a className="citationLink" href="tel:1800008002">
                1800 008 002
              </a>
              <p>
                - If you are in Darwin and need to arrange testing call the
                Public Health Unit on:{" "}
                <a className="citationLink" href="tel:89228044">
                  8922 8044
                </a>
              </p>
            </li>
            <li>
              Tasmania:{" "}
              <a className="citationLink" href="tel:1800671738">
                1800 671 738
              </a>
              <p>
                - If you need an interpreter, phone the Tasmanian Interpreting
                Service (TIS) on{" "}
                <a className="citationLink" href="tel:131450">
                  131 450
                </a>{" "}
                and tell them your language.
              </p>
              <p>
                - Tell the interpreter your name and that you’re calling the
      ...
      <h2 className="responsiveH2">
        Other interesting links to learn about the current situation
      </h2>
      <div className="row alignStyles responsiveText">
        <div>
          <ul>
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://medium.com/@tomaspueyo/coronavirus-the-hammer-and-the-dance-be9337092b56"
              >
            ...
            <li>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.economist.com/news/2020/03/11/the-economists-coverage-of-the-coronavirus"
              >
                Economist
              </a>{" "}
              are giving people free access to their coronavirus coverage. It's
              really good!
            </li>
          </ul>
        </div>
      ...
      <h2 className="responsiveH2">
        List of Hospitals doing Coronavirus testing
      </h2>
      <p className="responsiveText">
        <strong>Note: </strong>For anyone in Tasmania, all four testing clinics
        will not be open for walk-up testing, and anyone who thinks they may
        need testing should first contact the Public Health Hotline on{" "}
        <a className="citationLink" href="tel:1800671738">
          1800 671 738
        </a>
      </p>
