        ...
        <Grid container spacing={gspace} justify="center" wrap="wrap">
          <Grid item xs={12} className="removePadding">
            ...
            {/*<AlertTitle><strong>Important!!</strong></AlertTitle>*/}
                <p style={{fontSize:"0.85rem"}} className="card-text">To improve our site, we are working with researchers from Monash University and Rochester Institute of Technology, to investigate how our users seek information about COVID-19.  If you could fill in this &nbsp;<a target="_blank"  rel="noopener noreferrer" href="https://docs.google.com/forms/d/e/1FAIpQLSdPMLY_4M6HVBCGbFqDVbfcoKcuM5fUeDpPR77Xc_nhBp9vZA/viewform?usp=sf_link" ><u><strong>10-min survey</strong></u></a>, we would be very grateful. <br/>The survey results will eventually be released at <a target="_blank"  rel="noopener noreferrer" href="https://covid19onlinesurvey.org" ><u>https://covid19onlinesurvey.org</u></a></p>
