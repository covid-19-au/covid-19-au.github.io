  ...
  return (
    ...
    <div className="fallback">
      <div>
        ...
        }} variant="outlined" startIcon={<ShareIcon />} className={classes.button}>
          Share this site
        </Button>

        <Button href="https://docs.google.com/forms/d/e/1FAIpQLSeX4RU-TomFmq8HAuwTI2_Ieah60A95Gz4XWIMjsyCxZVu7oQ/viewform?usp=sf_link" variant="outlined" startIcon={<FeedbackIcon />} className={classes.button}>
          Feedback
        </Button>
        <Button href="/faq" variant="outlined" startIcon={<InfoSharpIcon />} className={classes.button}>
          FAQ
        </Button>
        <Button href="https://github.com/covid-19-au/covid-19-au.github.io" variant="outlined" startIcon={<GitHubIcon />} className={classes.button}>
          GitHub
        </Button>
        <Button href="/about-us" variant="outlined" startIcon={<PeopleIcon />} className={classes.button}>
          About Us
        </Button>
      </div>
