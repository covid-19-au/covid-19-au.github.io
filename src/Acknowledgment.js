        ...
        <DialogContent dividers={scroll === "paper"}>
          ...
          >
            ...
            <p>
              ...
              We are a volunteer team and we use the data we collect strictly
              for non-commercial, educational,reporting and research purposes.
              Care is taken to ensure the data is accurate, and not reframed or
              misrepresented.
            </p>
            {/* <p style={{ marginTop: "2px" }}>
              We are not affiliated to nor endorsed by these organisations in
              any way. We are a volunteer team and we use the data we collect
              strictly for non-commercial, educational,reporting and research
              purposes. Care is taken to ensure the data is accurate, and not
              reframed or misrepresented.
            </p> */}
            <p>
              We strongly recommend that users of this website adhere to the
              advice and regulations provided by their respective local and
              federal governments and authorities.
            </p>
            <p>
              If you have concerns, please contact us through our{" "}
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSeX4RU-TomFmq8HAuwTI2_Ieah60A95Gz4XWIMjsyCxZVu7oQ/viewform"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "#5499C7" }}
              >
