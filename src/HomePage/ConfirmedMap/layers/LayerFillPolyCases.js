  ...
  constructor(map, useID, caseDataSource) {
    ...
    var click = (e) => {
      ...
      if (caseDataSource.getCaseNumberTimeSeries) {
        let timeSeries = caseDataSource.getCaseNumberTimeSeries(cityName, null);
      ...
      (async () => {
        try {
          dvAna({
            ...
            dateSlider: new Date(map.dvAnaClickContext.maxDate).toISOString(),
          });
        } catch (e) {
          return null;
        }
