            ...
            <div className="card" style={{
                ...
                <span className="due">
                    <ul ref={this.accuracyWarning} style={{margin: '0px', padding: '0px'}}>
                        <li style={{color: '#555', marginBottom: '2px', paddingBottom: '0px'}}>Zoom in for regional numbers. Click regions for history over time and updated dates.</li>
                        <li style={{color: '#555', marginBottom: '2px', paddingBottom: '0px'}}>Regional data is autogenerated and may not be as up-to-date as statewide figures.<br />
                            Displayed cases identify regions only, not specific addresses.</li>
                        <li style={{color: '#555'}}>Regional data updated: {
