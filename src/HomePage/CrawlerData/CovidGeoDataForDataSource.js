...
class CovidGeoDataForDataSource {
    constructor(covidGeoData, dataSource) {
        this.covidGeoData = covidGeoData;
        this.dataSource = dataSource;

        this.pointData = {};
        this.polyData = {};

        this._associateSource(covidGeoData, dataSource)
    }
    ...
    _associateSource(covidGeoData, dataSource) {
